...
<body>
    ...
    <div class="content">
        ...
        <div class="section" id="bikes">
            ...
            <table>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        <td colspan="10" style="text-align:center;">No bikes found.</td>
                    </tr>
                ...
                <?php if ($users && mysqli_num_rows($users) > 0): ?>
                    <?php while ($u = mysqli_fetch_assoc($users)): ?>
                        <tr>
                            ...
                            <td> <a href="Users/users_edit.php?id=<?php echo $u['user_id']; ?>" class="btn-edit">Edit</a> <a
                                    href="Users/users_delete.php?id=<?php echo $u['user_id']; ?>" class="btn-delete"
                                    onclick="return confirmDelete()">Delete</a> </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="3" style="text-align:center;">No users found for your bikes.</td>
                    </tr>
                <?php endif; ?>
            </table>
        </div> 
        ...
        <div class="section" id="bookings">
            <h3>Bookings</h3> <a href="Bookings/booking_add.php" class="add-btn">+ Add Booking</a>
            <table>
                <tr>
                    <th>User</th>
                    <th>Bike</th>
                ...
                <?php if ($bookings && mysqli_num_rows($bookings) > 0): ?>
                    <?php while ($b = mysqli_fetch_assoc($bookings)): ?>
                        <tr>
                            ...
                            <td>
                                <?php echo htmlspecialchars($b['bike_name']); ?>
                            </td>
                            <td>
                            ...
                            <td>Rs
                                <?php echo $b['total_price']; ?>
                            </td>
                            <td> <a href="Bookings/bookings_edit.php?id=<?php echo $b['id']; ?>" class="btn-edit">Edit</a> <a
                                    href="Bookings/bookings_delete.php?id=<?php echo $b['id']; ?>" class="btn-delete"
                                    onclick="return confirmDelete()">Delete</a> </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
